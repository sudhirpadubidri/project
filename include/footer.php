<footer id="footer">
  <div id="slideContainer">
    <div id="slide1">
      <div id="desc">
        <div id="details">
        <h3> Project Management System is a platform from which employees and managers are for collaboration and
          communication.<br><br>
       ...
       FUNCTIONS OF THIS SYSTEM :<br>
          - Add new user 
    : a unique User ID will be created automatically <br>
- Allocate task to particular user 
    : a unique Task ID will be created automatically<br>
    : default status will be 'In progress'<br>
- Manage Task
    : Change the task<br>
    : Change status<br>
    : Delete the task<br>
